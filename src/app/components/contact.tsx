      ...
      <div className="w-full max-w-4xl mx-auto px-4">
        ...
        <div className="flex flex-col gap-8 mb-16">
          {contactInfo.map((category, index) => (
            ...
            >
              <h3 className="text-[var(--textColor_3)] text-2xl font-medium mb-8">
                {category.title}
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {category.items.map((item, itemIndex) => (
                  <motion.div
                    ...
                    className="flex items-center gap-4 p-4 rounded-lg bg-[var(--themeColor_1)] border border-[var(--themeColor_2)]/30 hover:bg-[var(--themeColor_2)]/10 transition-all"
                  >
                    <Link
                      href={item.href}
                      target={
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-[var(--textColor_3)] hover:text-[var(--themeColor_2)] transition-colors text-sm">
                          {item.value}
                        </p>
                      </div>
                    </Link>
              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-[var(--textColor_3)] hover:text-[var(--themeColor_2)] text-sm">
                      {social.username}
                    </p>
                  </div>
                </Link>

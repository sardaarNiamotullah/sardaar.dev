  ...
  return (
    <section id="tools" className="w-full py-24">
      <div className="w-full max-w-4xl mx-auto px-4">
        ...
        {/* Skills Grid - Single column layout */}
          ...
          {skillCategories.map((category, index) => (
            ...
            >
              <div className="flex items-center gap-4 mb-8">
                <div className="text-[var(--themeColor_2)] p-3 bg-[var(--themeColor_1)] rounded-lg border border-[var(--themeColor_2)]/20">
                  {category.icon}
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h4 className="text-[var(--textColor_3)] text-sm font-medium uppercase tracking-wider">
                      Experienced in
                    </h4>
                  </div>
